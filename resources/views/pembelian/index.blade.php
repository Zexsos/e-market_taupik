    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button type="button" class="btn btn-tooll" data-card-widget="collapse" title="Collapse"><i class="fas fa-minus"></i></button>
        ...
        <div class="card-body">
            ...
            <form class="" id="formTransaksi" method="POST">
                ...
                <div class="row">
                    <div class="col-6">
                        <label for="kode-pembelian" class="col-5 col-form-label col-form-label-sm">Kode Pembelian</label>
                        <div class="col-8">
                            <input type="text" class="form-control forw-control-sm" id="kode-pembelian" placeholder="" readonly value="{{$kode}}" name="kode_masuk">
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="date-picker form-control col-md-7 col-xs-12" required="required" type="date" value="{{date('Y-m-d')}}" name="tanggal">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                        <label class="control-label col-md-6 col-sm-6 col-xs-12">Disrtibutor
                        </label>
                        <div class="col-md-6 col-sm-9 col-xs-12">
                            <select class="form-controll col-md-4 col-xs-12" required="required" name="pemasok_id">
                ...
                <div class="row justify-content-end" style="text-align:right;">
                    <label class="control-label col-md-2 col-sm-2 col-sm-2 offset-md-7">Total Harga</label>
                    <div class="col-md-3 mr-md-auto" style="padding-right:10px; align-content:right;">
                        <input class="form-control col-md-8 col-xs-17" style="margin-left:80px;" required="required" type="text" id="totalHarga" name="total">
                    </div>
                </div>
                <div class="row">
